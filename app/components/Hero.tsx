...
export default function Hero() {
    return (
        ...
        >
            <div className="relative z-10 flex flex-col items-center text-center px-6 translate-y-20 sm:translate-y-32">
                {/* Logo / Monogram */}
                <motion.div
                    ...
                    className="mb-8"
                >
                    <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-br from-cyan-500 via-teal-500 to-cyan-600 flex items-center justify-center shadow-2xl shadow-cyan-500/30 rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <motion.p
                    ...
                    className="mt-6 text-xl sm:text-2xl md:text-3xl font-semibold text-slate-200 tracking-wide font-inter"
                >
