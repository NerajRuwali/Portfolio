...
export default function ResumeSection() {
    return (
        <section
            id="resume"
            className="relative py-24 px-6 sm:px-10 lg:px-16 bg-black overflow-hidden"
        >
            {/* Ambient background blobs */}
            <div className="absolute inset-0 bg-gradient-to-b from-black via-slate-950 to-black pointer-events-none" />
            <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-emerald-500/5 blur-[120px] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center gap-10">
                ...
                >
                    {/* Decorative top bar */}
                    <div className="w-12 h-1 rounded-full bg-gradient-to-r from-emerald-400 to-cyan-500 mx-auto mb-8" />
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <motion.a
                            ...
                            className="group flex items-center gap-2.5 px-7 py-3.5 rounded-xl font-semibold text-sm font-inter text-white bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:shadow-xl transition-shadow duration-300 w-full sm:w-auto justify-center"
                        >
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.97 }}
                            transition={{ type: 'spring', stiffness: 400, damping: 20 }}
                            className="group flex items-center gap-2.5 px-7 py-3.5 rounded-xl font-semibold text-sm font-inter text-emerald-300 border border-emerald-400/40 bg-emerald-500/[0.08] hover:bg-emerald-500/15 hover:border-emerald-400/60 hover:text-white transition-all duration-300 w-full sm:w-auto justify-center"
                        >
