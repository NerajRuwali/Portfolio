...
const projects = [
    ...
    {
        title: 'GitLit',
        description: 'GitLit is a AI Powered full-stack web application that provides detailed insights into GitHub repositories and developer activity. It enables users to analyze contribution patterns, repository metrics, and code activity through an interactive and visually structured interface..',
    ...
    {
        title: 'HireLens',
        description: 'AI-powered resume analysis platform that evaluates resumes based on ATS standards with match scoring, strengths/weaknesses analysis, and skill gap detection.',
    ...
    },
    {
        ...
        description: 'ML-powered customer segmentation using K-Means clustering to group customers based on purchasing behavior for targeted marketing insights.',
    ...
    },
    {
        ...
        description: 'Aspiring Software Engineer skilled in MERN stack, DSA, and AI-driven development. I build scalable full-stack applications and explore Agentic AI to create intelligent systems',
...
export default function Projects() {
    return (
        <section id="projects" className="relative min-h-screen py-20 px-6 sm:px-10 lg:px-16 bg-black overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-b from-black via-slate-950 to-black pointer-events-none" />
            <div className="absolute top-12 left-10 w-72 h-72 rounded-full bg-emerald-500/10 blur-3xl animate-pulse" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="text-center mb-12 md:mb-16">
                    <p className="inline-block px-4 py-1 text-xs font-semibold tracking-widest text-red-300 uppercase bg-red-500/15 rounded-full border border-red-400/30 font-inter">
                        Projects
                    </p>
