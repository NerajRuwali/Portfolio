...
export default function About() {
    return (
        <section id="about" className="relative py-24 px-6 sm:px-10 lg:px-16 overflow-hidden">
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm pointer-events-none" />
            <div className="absolute top-20 right-10 w-80 h-80 rounded-full bg-cyan-500/10 blur-3xl animate-pulse" />
                ...
                >
                    ...
                    <div className="flex justify-center pt-4">
                        <a
                            ...
                            className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-white/[0.04] border border-white/10 hover:bg-cyan-500/10 hover:border-cyan-400/30 transition-all duration-300"
                        >
                            <HiMail className="text-xl text-cyan-400 group-hover:scale-110 transition-transform" />
